# This script usese Theano to Build a Recurrent Neural Network For POS Tagging of Real World Data Set (Wall Street Journal)
...
class RNN:
    """RNN on Real World Data Sets Using Theano"""
