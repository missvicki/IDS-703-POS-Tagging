# This script usese Theano to Build a Recurrent Neural Network For POS Tagging of Synthetic Data Generated
# by ngram language model.

# some python 2 code has been used so __future__module ensures smooth integration
# with python 3 code
...
# use recurrent units in neural network
from rnn.gru import GRU

# import abstracted function that retrieves train and test data from "pos_data" directory
from pos_baseline_synthetic import get_data
...
class RNN:
    ...
    def fit(
        ...
        self.train_op = theano.function(
            inputs=[thX, thY], outputs=[cost, prediction], updates=updates
        )
...
# main function that carries out evaluation of recurrent neural network for PoS tagging
def main():
